...
  call void @llvm.lifetime.start.p0(i64 4096, ptr nonnull %x)
  br i1 %tobool.not, label %if.else, label %B

if.else:                                          ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 4096, ptr nonnull %y)
...
  call void @llvm.lifetime.end.p0(i64 4096, ptr nonnull %x)
  call void @llvm.lifetime.end.p0(i64 4096, ptr nonnull %y)
  ret void
}